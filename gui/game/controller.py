...
class GameController (RelativeLayout):
    ...
    def saveToDb(self):
        ...
        if db_id == 0:
            ...
            query = "INSERT INTO `snakes` (snake_id, player_type, highscore, best_weights, best_fitness, worst_weights, worst_fitness, fitness_max, fitness_min, fitness_avarage, score_max, score_min, score_avarage, generations, population, iterations, eta, epochs, batch, start_size, fitness_function_id, mutation_rate, activation_functions, output_functions, last_update) VALUES (" + str(self.data.snakeId) + ", " + str(self.type) + ", " + str(self.data.highscore) + ", \"" + str(self.data.bestSnake.weights) + "\", " + str(self.data.bestSnake.fitness) + ", \"" + str(self.data.worstSnake.weights) + "\", " + str(self.data.worstSnake.fitness) + ", \"" + str(self.data.fitnessMax) + "\", \"" + str(self.data.fitnessMin) + "\", \"" + str(self.data.fitnessAvarage) + "\", \"" + str(self.data.scoreMax) + "\", \"" + str(self.data.scoreMin) + "\", \"" + str(self.data.scoreAvarage) + "\", " + str(self.data.generation) + ", " + str(self.data.population) + ", " + str(self.data.iterations) + ", " + str(self.data.eta) + ", " + str(self.data.epochs) + ", " + str(self.data.batch) + ", " + str(self.data.startSize) + ", " + str(2) + ", " + str(self.data.mutationRate) + ", \"" + str(self.data.snakes[0].ai.activationF) + "\", \"" + str(self.data.snakes[0].ai.outputF) + "\", \"" + str(self.lastUpdate) + "\");"
